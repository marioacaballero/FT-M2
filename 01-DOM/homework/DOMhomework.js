...
function addToDo() {
  ...
  let newToDo = new ToDo(toDoInput.value) //porque si uso sin el punto no contiene nada, el value es el que tiene el texto.

  toDoItems.push(newToDo);
  toDoInput.value = ""; //para resetearlo cuando ya agregue algo
...
// Tu código acá:
let bttAd = document.getElementById('addButton');
bttAd.addEventListener('click', addToDo);
